#!/usr/bin/env python3
"""
For Wookianos,Tint & Fantuwa fonts (poorly render letters ቨ - ቯ, ጷ).
...
output_root_dir = "."
output_file_name = "amh-layer.training_txt-wookianos"
...
# filter out letters ቨ - ቯ, ጷ (poorly rendered by Wookianos,Tint & Fantuwa fonts)
filter_funcn = lambda w: not (re.search(r"[\u1268-\u126F]", w) or re.search(r"\u1337", w))
