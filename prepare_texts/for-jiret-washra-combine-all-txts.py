#!/usr/bin/env python3
"""
For WashRa & Jiret Fonts (poorly render letters ቨ - ቯ).
...
output_root_dir = "."
output_file_name = "amh-layer.training_txt-jiret"
...
# filter out letters ቨ - ቯ (poorly rendered by Jiret and WashRa fonts)
filter_funcn = lambda w: not re.search(r"[\u1268-\u126F]", w)
